...
| Prefeitura / Fornecedores | Preservar fornecedores brutos | paginação integral | 2026-08-14 | 361 | nenhum na execução 12 | operacional |
| Prefeitura / Contratos | Preservar contratos brutos | paginação integral | 2026-08-14 | 1.275 | nenhum após revalidação na execução 16 | operacional |
| Prefeitura / Licitações | Preservar licitações brutas | paginação integral | 2026-08-14 | 1.073 | nenhum após revalidação na execução 17 | operacional |
| Prefeitura / Fiscais de contrato | Preservar fiscais brutos | paginação concluída | 2026-08-14 | 0 | resposta oficial vazia na execução 15 | parcial |
...
Compras públicas: `php artisan collect:prefeitura-procurement {resource}`, versão `1.1.0`. As execuções 12, 16 e 17 preservaram integralmente fornecedores, contratos e licitações. Campos nulos documentados pelo OpenAPI são aceitos; payload e checksum permanecem imutáveis. Fiscais respondeu vazio e ficou parcial.
