    ...
    <div class="min-h-screen bg-stone-50 text-slate-950">
        ...
        <main>
            <section class="border-b border-slate-200 bg-slate-950 text-white"><div class="mx-auto max-w-6xl px-5 py-16 sm:px-8 sm:py-24">
                ...
                <div v-if="hasPublicData" class="mt-10 flex flex-wrap gap-3"><Link :href="route('people.index')" class="rounded bg-amber-400 px-5 py-3 font-bold text-slate-950 hover:bg-amber-300">Buscar pessoa</Link><Link :href="route('organizations.index')" class="rounded border border-white/30 px-5 py-3 font-bold text-white hover:bg-white/10">Explorar órgãos públicos</Link><Link :href="route('sources.index')" class="rounded border border-white/30 px-5 py-3 font-bold text-white hover:bg-white/10">Ver fontes e saúde</Link></div>
            ...
            <section class="border-t border-slate-200 bg-white"><div class="mx-auto grid max-w-6xl gap-10 px-5 py-14 sm:px-8 md:grid-cols-3">
                ...
                <article><p class="text-sm font-black uppercase tracking-widest text-teal-700">Consulta</p><h2 class="mt-3 text-2xl font-bold">Busca e perfis</h2><p class="mt-3 leading-7 text-slate-600">Consulte vínculos e remunerações por nome ou matrícula, sempre com a fonte oficial indicada.</p></article>
            </div></section>
        </main>
